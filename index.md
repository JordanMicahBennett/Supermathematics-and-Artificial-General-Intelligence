...
Anyway, to build an “Edward Witten/String theory powered artificial neural network”, it may be possible to start with a [grasmann based artificial neural network](https://arxiv.org/pdf/1611.05742.pdf), in the following fashion, then [generate ‘charts’](http://www.math.wisc.edu/~robbin/761dir/grassmann.pdf) until [scenarios occur](https://en.wikipedia.org/wiki/Supersymmetry) where the “Edward Witten/String theory powered artificial neural network” is achieved:
