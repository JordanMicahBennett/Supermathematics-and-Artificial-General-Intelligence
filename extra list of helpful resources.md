...
13. [The supersymmetric tensor hierarchy of N = 1, d = 4 supergravity](https://arxiv.org/pdf/0903.0509.pdf) (This is not to be confused for the [Supersymmetric/Symmetric tensor](https://en.wikipedia.org/wiki/Symmetric_tensor) from Mathematics, as seen in [Multilinear algebra](ftp://ftp.esat.kuleuven.be/pub/SISTA/ida/reports/97-75.pdf) ) 
