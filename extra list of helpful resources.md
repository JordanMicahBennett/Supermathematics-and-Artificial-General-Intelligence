...
13. [The supersymmetric tensor hierarchy of N = 1, d = 4 supergravity](https://arxiv.org/pdf/0903.0509.pdf) (Concerns QFT. This is not to be confused for [Supersymmetric/Symmetric tensors](https://en.wikipedia.org/wiki/Symmetric_tensor) from Mathematics, as seen in [Higher Order Symmetric Tensors](https://arxiv.org/pdf/1201.3424). Pertinently, [(see this paper, describing the phenomena of "super" tensor labelling errors)](https://arxiv.org/pdf/0802.1681) Notably, [recent higher order tensor papers](https://arxiv.org/pdf/1701.0542) are still commiting the "super" labelling error, as descrived in the)
