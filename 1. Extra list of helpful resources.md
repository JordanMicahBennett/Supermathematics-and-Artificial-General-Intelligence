...
27. [A study on neural learning on manifold foliations: the case of the Lie group SU(3)](https://www.ncbi.nlm.nih.gov/pubmed/18085982) (Concerns neural learning on manifold foliations: the case of the Lie group SU(3); although I am imstead interested in SU(m|n), or some ringed SU(p,q) representation, for supersymmetric expression. This study not partition the solution space in terms of Supercharges, which is required for supersymmetric expression.)

28. [Gaussian elimination in unitary groups with an application to cryptography](https://arxiv.org/pdf/1409.6136.pdf) (Concerns gaussian elimination in the scope of [generalized special unitary group](https://en.wikipedia.org/wiki/Special_unitary_group#Generalized_special_unitary_group), with respect to cryptography.)
