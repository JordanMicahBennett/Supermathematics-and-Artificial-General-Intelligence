...
16. [On the weak N-dependence of SO(N) and SU(N) gauge theories in 2+1 dimensions](http://www.sciencedirect.com/science/article/pii/S0370269315006243) (Concerns relationships, showing that "low N pairs of SO(N) and SU(N′) theories are known to possess the same Lie algebras", including "SU(2) and SO(3)"...)
